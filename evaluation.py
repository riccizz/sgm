...
def cal_fid(data_pools,all_pools,eps=1e-6):
  mu1 = np.mean(data_pools,axis=0)
  sigma1 = np.cov(data_pools,rowvar=False)
  mu2 = np.mean(all_pools,axis=0)
  sigma2 = np.cov(all_pools,rowvar=False)
